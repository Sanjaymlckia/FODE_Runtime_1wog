...
function fixtureHtml() {
  ...
  const mock = `<script>
    ...
    window.__workload = function (payload) {
      var page = Number(payload.page || 1); var pageSize = Number(payload.pageSize || 25); var matched = window.__rows.filter(function (row) { return !payload.actionabilityState || row.actionabilityState === payload.actionabilityState; }); var offset = (page - 1) * pageSize;

...
assert.match(reviewQueues, /docsReviewVerified = docsVerifiedRaw === "Yes" \|\| computeDocVerificationStatus_\(rowObj\) === "Verified"/, "Queue classifier must derive document-verified state from raw or computed status");

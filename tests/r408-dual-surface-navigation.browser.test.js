...
async function assertResponsiveLayouts(browser, viewport) {
  ...
  const loadedOperations = `<section id="opsCommunications" class="opsSectionPage">${loadedWorkspaceSwitch}<div class="opsSectionGrid" style="grid-template-columns:minmax(260px,.85fr) minmax(360px,1.1fr) minmax(340px,1fr);"><div class="opsCard">Loaded communications cohort</div><div class="opsCard">Loaded communication controls</div><div class="opsCard">Loaded audit context</div></div></section>`;

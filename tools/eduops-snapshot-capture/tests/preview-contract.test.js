...
assert.match(captureSource, /evidence[\s\S]*generated[\s\S]*snapshots/, "Capture must store only in ignored generated snapshots");
assert.match(captureSource, /--dry-run/, "Capture must expose a no-browser dry-run mode");

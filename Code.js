...
function isAdminDeploymentRequest_() {
  try {
    var current = canonicalExecBase_(ScriptApp.getService().getUrl() || "");
    var adminBase = canonicalExecBase_(CONFIG.DEPLOYMENT_ID_ADMIN || CONFIG.WEBAPP_URL_ADMIN || CONFIG.WEBAPP_URL || "");

...
function buildCanonicalPopulationRow_(rowObj, rowNumber, opts) {
  ...
  var actionability = {
    ...
    reviewBucketKey: clean_(authorityRow.reviewBucketKey || ""),
    reviewBucketLabel: clean_(authorityRow.reviewBucketLabel || ""),
    admissionsStageKey: clean_(authorityRow.admissionsStageKey || ""),
    admissionsStageLabel: clean_(authorityRow.admissionsStageLabel || ""),
    reviewReason: clean_(authorityRow.reviewReason || ""),
    reviewRequirement: clean_(authorityRow.reviewRequirement || ""),
    reviewWaitingOn: clean_(authorityRow.reviewWaitingOn || ""),
    reviewSourceEvidence: clean_(authorityRow.reviewSourceEvidence || ""),
    reviewFollowupCount: Number(authorityRow.reviewFollowupCount || 0),
    reviewCommunicationEvidenceAvailable: authorityRow.reviewCommunicationEvidenceAvailable === true,
    reviewOwner: clean_(authorityRow.reviewOwner || authorityRow.actionOwner || ""),
    reviewDate: clean_(authorityRow.reviewDate || ""),
    reviewReactivationCondition: clean_(authorityRow.reviewReactivationCondition || ""),
    reviewLastMeaningfulActivity: clean_(authorityRow.reviewLastMeaningfulActivity || authorityRow.lastRelevantDate || ""),
    ...
    communicationReminderCount: Number(authorityRow.authorityState && (authorityRow.authorityState.communicationReminderCount || authorityRow.authorityState.communicationSuccessfulSendCount) || 0),
    communicationReminderDue: authorityRow.authorityState && authorityRow.authorityState.communicationReminderDue === true,
    communicationReminderExhausted: authorityRow.authorityState && authorityRow.authorityState.communicationReminderExhausted === true,
    communicationLastAttemptAt: clean_(authorityRow.authorityState && authorityRow.authorityState.communicationLastAttemptAt || ""),
    communicationLastAttemptResult: clean_(authorityRow.authorityState && authorityRow.authorityState.communicationLastAttemptResult || ""),
    communicationNextActionAt: clean_(authorityRow.authorityState && authorityRow.authorityState.communicationNextActionAt || ""),

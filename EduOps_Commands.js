...
function eduops_previewCommand(payload) {
  ...
  var preview = {
    ...
    statusReason: authorityReady ? "Final confirmation is required before execution." : eduopsClean_(authorityPreview && (authorityPreview.message || authorityPreview.error) || "Authoritative preview is not executable."),

...
| legacy lifecycle stage in Communication Authority | Compatibility shim | final send gate fallback | keep until Communication Authority migration is fully proven |
